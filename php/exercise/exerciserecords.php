        ...
        <div class="container">
          <div class="jumbotron" id = "frontPageInfo">
            ...
            <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Reps</label>
                            <div class="col-sm-10">
                              <input type="reps" class="form-control" id="txtreps" placeholder="reps">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Sets/Duration</label>
                            <div class="col-sm-10">
                              <input type="setsduration" class="form-control" id="txtsetsduration" placeholder="sets/duration">
                            </div>
                          </div>            
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Calories Burned</label>
                            <div class="col-sm-10">
                              <input type="caloriesburned" class="form-control" id="txtcaloriesburned" placeholder="calories burned">
                            </div>
                          </div>
                </form>          
          ...
          (function($){
            $(function(){
              $("#add").on('click', function(e){
                ...
                $("#table").append("<tr> <td> " + name + " </td> <td> " + calories + " </td> <td> "  + totalfat + " </td> <td> "  + sugar + " </td> <td> "  + Date() + " </td> </tr>");            
                return false;
              });
            });
          })(jQuery);            
