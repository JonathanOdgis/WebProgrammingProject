  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="page-header">
          <h1>Drink Intake <small>Record your daily beverages</small></h1>
        </div>
            <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="txtName" class="col-sm-2 control-label">Name</label>
                            <div class="col-sm-10">
                              <input type="name" class="form-control" id="txtname" name = "Name" placeholder="name" value="<?=$beverage['Name']?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="txtName" class="col-sm-2 control-label">Calories</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="txtcalories" name = "Calories" placeholder="calories"  value="<?=$beverage['Calories']?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Total Fat</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="txttotalfat" name = 'TotalFat' placeholder="total fat"  value="<?=$beverage['TotalFat']?>" >
                            </div>
                          </div>            
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Sugar</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="txtsugar" name = "Sugar" placeholder="sugar" value="<?=$beverage['Sugar']?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Servings</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="txtservings" name = "Servings" placeholder="servings" value="<?=$beverage['Servings']?>">
                            </div>
                          </div> 
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="txtDate">When did you eat</label>
                            <div class="col-sm-10">
                                  <input type="text" class="form-control date" id="txtDate" name="Time" placeholder="Date"  value="<?=$beverage['Time']?>">
                            </div>
                          </div>      
