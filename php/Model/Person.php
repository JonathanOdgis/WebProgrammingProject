	...
	static public function Blank()
	{
		...
		static public function Save(&$row)
		{
			...
			if (!empty($row['persons_id'])) {
				$sql = "Update Persons Set firstname='$row2[firstname]', Birthday='$row2[Birthday]' WHERE persons_id = $row2[persons_id]";
			}else{
				$sql = "INSERT INTO Persons(firstname, Birthday, created_at) VALUES ('$row2[firstname]', '$row2[Birthday]', Now() ) ";				
			}
